...
- (void)viewDidLoad
{
    ...
    UITableView* tableViewController = [storyboard instantiateViewControllerWithIdentifier:@"tabelview"];
    UIViewController* spaceImageViewController = [storyboard instantiateViewControllerWithIdentifier:@"spaceImage"];
    
    [self.viewControllerArray addObjectsFromArray:@[demo,demo2,demo3,demo4, tableViewController, spaceImageViewController]];
}
...
-(void)setupSegmentButtons {
    ...
    if (!buttonText) {
         buttonText = [[NSArray alloc]initWithObjects: @"first",@"second",@"third",@"fourth",@"table",@"image",@"etc",@"etc",nil]; //%%%buttontitle
    }
